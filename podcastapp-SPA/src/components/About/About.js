...
const About = () => {
    ...
    const strobeAnimation = (e) => {
        const lines = e.target.querySelectorAll('[class$="grouped1"]');
        lines.forEach(line => {
            line.style.animationDelay = Math.random() + 's';
            let duration = Math.random() > .5 ? 2 : 1;
    ...
    return (
        <animated.div className="about-container" style={fade} >
            ...
            <div className="about-container-bottom">
                <div className="about-container-card" onMouseEnter={(e) => animate(e)}>
